  ...
  return (
    <div>
      ...
      <p style={s.p}>
        ...
        our title, but we'll be adding plenty of text later on, so why not have
        some fun right now?!?
      </p>
      <ol>
        <li>
        ...
        <li>
          Find a font you like, and click the red plus button, this will put
        ...
        <li>
          Copy and paste this link into your <code>style.css</code> file in
          the <code>body</code> CSS selector like the code example shows below
        </li>
      ...
      <p style={s.p}>
        ...
        different fonts on different titles and paragraphs of your site by adding
        the <code>font-family</code> rule different CSS selectors and changing the fonts.
      </p>
      <p style={s.p}>
