  ...
  return (
    <div>
      ...
      <p style={s.p}>
        ...
        one of the most important parts of science, so write your steps such that someone
        else could follow them and repeat your science project. Lets get started by
        copying the HTML in the code example below into your <code>site.html</code> file.
      </p>
      ...
      <p style={s.p}>
        ...
        and <code>[step description]</code> text with the step names and descriptions
        that will help others repeat your project setup and procedure. As usual, save
        your <code>site.html</code> file in Care, and refresh your <code>site.html</code> tab
        in Chrome to see your changes.
      </p>
      <p style={s.p}>
