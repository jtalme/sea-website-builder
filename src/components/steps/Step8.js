  ...
  return (
    <div>
      ...
      <p style={s.p}>
        ...
        different variable. Copy the HTML below into your own <code>site.html</code> file,
        save the file in Caret, and refresh the page in Chrome.
      </p>
      ...
      <p style={s.p}>
        ...
        for unordered list, and <code>&lt;li&gt;</code> stands for list item.
      </p>
      <p style={s.p}>
